...
namespace Edulink.Windows
{
    public partial class FrmInscripcionExamenes : Form
    {
        ...
        private IServiciosInscripcionExamenes _servicioEstudianteExamenes;
        ...
        {
            InitializeComponent();
            _servicioEstudianteExamenes = new ServiciosInscripcionExamenes();
        ...
        //    try
        //    {
        //        _registrosTotales = _servicioEstudianteExamenes.GetCantidad(_carrera);// obtiene la cantidad total de registros.
