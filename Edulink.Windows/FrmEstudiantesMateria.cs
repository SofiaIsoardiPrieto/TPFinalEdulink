...
{
    public partial class FrmEstudiantesMateria : Form
    {
        ...
        {
            GridHelper.LimpiarGrilla(dgvDatosEstudiantesMateria);
            foreach (var estudianreExamenDto in _lista)
            {
                DataGridViewRow r = GridHelper.ConstruirFila(dgvDatosEstudiantesMateria);
                GridHelper.SetearFila(r, estudianreExamenDto);
                GridHelper.AgregarFila(dgvDatosEstudiantesMateria, r);
            }
        ...
        private void tsEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvDatosEstudiantesMateria.SelectedRows.Count == 0) { return; }
            var r = dgvDatosEstudiantesMateria.SelectedRows[0];
